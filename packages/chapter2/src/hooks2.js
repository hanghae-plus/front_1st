export function createHooks(callback) {
	...
	const useState = (initState) => {
		...
		const setState = (newState) => {
			...
			if (stateContext.animationFrameId !== null) {
				cancelAnimationFrame(stateContext.animationFrameId);
			}

			stateContext.animationFrameId = requestAnimationFrame(() => {
				callback();
				stateContext.animationFrameId = null;
			});
		};
