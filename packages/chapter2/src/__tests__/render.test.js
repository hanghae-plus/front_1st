...
describe('render > ', () => {
  describe('첫 번째 렌더링 테스트', () => {
    ...
    test('props를 추가할 수 있다.', () => {
      const App = jsx('div', { id: 'test-id', class: 'test-class' }, 'div의 children 입니다.')
  ...
  describe('리렌더링 테스트 - 변경된 내용만 반영되도록 한다.', () => {
    test('하위 노드 추가', () => {
      ...
      render($root, jsx('div', { id: 'test-id', class: 'test-class' }, jsx('p', null, '첫 번째 문단'), jsx('p', null, '두 번째 문단'), jsx('p', null, '세 번째 문단')), App)
    ...
    test('props 수정', () => {
      ...
      render($root, jsx('div', null, jsx('p', null, '첫 번째 문단'), jsx('p', null, '두 번째 문단')), App)
